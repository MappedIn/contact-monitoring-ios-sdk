...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/MappedinVenueFormat/MappedinVenueFormat.xcframework" "" "true" "ios-arm64/MappedinVenueFormat.framework" "ios-x86_64-simulator/MappedinVenueFormat.framework"
fi
